class People(object):
    ...
    def add_object(cls):
        ...
        while finished_adding_object == False:
            ...
            print "System >>> Please enter new " + cls.__name__ + " name. If the user doesn't want to create a new "\
                  + cls.__name__ + ", please enter \"exit\"."
            ...
            while pending_new_object != None:
                ...
                print "System >>> Please confirm, user wishes to create a new " + cls.__name__ + " called "\
                      + pending_new_object + " (y/n)?"
                ...
                if create_object_confirmation == "y":
                    ...
                    object_dictionary[pending_new_object] = new_object
                    # Object appended to global list so it can be referenced outside the class.
